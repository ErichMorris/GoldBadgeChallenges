...
namespace Challenge_02_Retry
{
    public class ProgramUI
    {
        ...
        private void SeeAllClaims()
        {
            ...
            {
                Console.WriteLine($"{claim.ClaimID, -5} {claim.TypeOfClaim, -12} {claim.ClaimDescription, -12}        {claim.ClaimAmount, -12} {claim.DateOfIncident, -12} {claim.DateOfClaim, -12}     {claim.IsValid, -12}", _claimRepo.GetClaims());
            }
            Console.WriteLine("--------------------------------------------------------------------------------------------------------------------");
            Console.WriteLine(" \n" +
                "\n" +
        ...
        private void TakeCareOfNextClaim()
        {
            ...
            Console.WriteLine("Type: {0}", claim.ClaimDescription);
            Console.WriteLine("Description: {0}", claim.ClaimDescription);
